...
conf = '/home/benedict/test/transformato-systems-master/output/methanol-methane-solvation-free-energy/input.yaml'
configuration = load_config_yaml(config=conf,
                                 input_dir='/home/transformato/transformato-systems', 
                                 output_dir='/home/test') #user_input 
