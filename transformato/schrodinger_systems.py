...
def cdk2_type1(conf_path: str, input_dir: str, output_dir: str):
    ...
    3  # defines the number of mutation steps for charge mutation
    )
    ...
    if type(configuration['simulation']['heavy_atoms']) == list:
        for h in configuration['simulation']['heavy_atoms']:
